...
import RiceImage from "../Image/rice.jpg";
import { ChevronLeftIcon, ChevronRightIcon } from '@heroicons/react/20/solid'

export default function RicePost() {
    const [rices, setRice] = useState([]);
    const [active, setActive] = useState(1);
    const recordsPerPage = 10;
    const lastIndex = active * recordsPerPage;
    const firstIndex = lastIndex - recordsPerPage;
    const records = rices.slice(firstIndex, lastIndex);
    const npage = Math.ceil(rices.length / recordsPerPage)
    ...
    useEffect(() => {
        fetch("http://localhost:5000/api/rice/").then((result) => {
        ...
        <>
            <div className="grid grid-rows-1 pt-20 md:grid-cols-2">
                <div className="xl:mt-16 mt-12 xl:ml-40 sm:ml-10">
                    <h5 className="text-2xl font-bold">Rice</h5>
                    ...
                    <div className="">
                        ...
                        <div>
                            <span className="relative inline-flex items-center gap-3 px-2 rounded ">
                                ...
                                <span className="pl-3">Angiospermae</span>
                        ...
                        <div>
                            <span className="relative inline-flex items-center gap-3 px-2 rounded ">
                                ...
                                <span className="pl-3">Oryza</span>
                        ...
                        <div>
                            <span className="relative inline-flex items-center gap-3 px-2 rounded ">
                                ...
                                <span className="italic">O. sativa</span>
            ...
            <div>
                <div className="flex flex-col xl:mt-20 mt-8 xl:ml-20 xl:mr-20 h-auto sm:ml-6">
                    <div className="mx-2 -my-2 overflow-x-auto sm:-mx-4 lg:-mx-8">
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-200">
                                        {records.map((rice, i) => (
                                            <tr key={i}>
                                                ...
                                                <td className="py-4 pl-4 pr-3 border-collapse border border-slate-300 text-sm font-medium text-gray-900 whitespace-nowrap sm:pl-1">
                                                    {rice.commonNameMetabolite}
                                                </td>
                                                <td className="py-4 pl-4 pr-3 border-collapse border border-slate-300 text-sm font-medium text-gray-900 sm:pl-1">
                                                    {rice.IUPACNameMetabolite}
                                                </td>
                                                <td className="py-4 pl-4 pr-3 border-collapse border border-slate-300 text-sm font-medium text-gray-900 whitespace-nowrap sm:pl-1">
                                                    {rice.molecularWeight}
                                                </td>
                                                <td className="py-4 pl-4 pr-3 border-collapse border border-slate-300 text-sm font-medium text-gray-900 whitespace-nowrap sm:pl-1">
                                                    {rice.molecularFormula}
                                                </td>
                                                <td className="py-4 pl-4 pr-3 border-collapse border border-slate-300 text-sm font-medium text-gray-900 sm:pl-1">
                                                    {rice.canonicalSmiles}
                                                </td>
                                                <td className="py-4 pl-4 pr-3 border-collapse border border-slate-300 text-sm font-medium text-gray-900 whitespace-nowrap sm:pl-1">
                                                    {rice.references}
                                                </td>
                    ...
                    <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                        <div>
                            <p className="text-sm text-gray-700">
                                ...
                                <span className="font-medium">{rices.length}</span> results
                            </p>
                        </div>
                        <div>
