...
import BajraImage from "../Image/bajra.jpg";

export default function BajraPost() {
    const [bajras, setBajra] = useState([]);
    const [active, setActive] = useState(1);
    const recordsPerPage = 10;
    const lastIndex = active * recordsPerPage;
    const firstIndex = lastIndex - recordsPerPage;
    const records = bajras.slice(firstIndex, lastIndex);
    const npage = Math.ceil(bajras.length / recordsPerPage)
    ...
    useEffect(() => {
        fetch("http://localhost:5000/api/bajras/").then((result) => {
        ...
        <>
            <div className="grid grid-rows-1 pt-20 md:grid-cols-2">
                <div className="xl:mt-16 mt-12 xl:ml-40 sm:ml-10">
                    <h5 className="text-2xl font-bold">Pearl Millet (Bajra)</h5>
                    ...
                    <div className="">
                        ...
                        <div>
                            <span className="relative inline-flex items-center gap-3 px-2 rounded ">
                                ...
                                <span className="pl-4">Poales</span>
                            </span>
                        </div>
                        <div>
                            <span className="relative inline-flex items-center gap-3 px-2 rounded ">
                                ...
                                <span className="pl-3">Poaceae</span>
                            </span>
                        </div>
                        <div>
                            <span className="relative inline-flex items-center gap-3 px-2 rounded ">
                                ...
                                <span className="pl-3">Pennisetum</span>
                        ...
                        <div>
                            <span className="relative inline-flex items-center gap-3 px-2 rounded ">
                                ...
                                <span className="italic">P. glaucum</span>
            ...
            <div>
                <div className="flex flex-col xl:mt-20 mt-8 xl:ml-20 xl:mr-20 h-auto sm:ml-10">
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-200">
                                        {records.map((bajra, i) => (
                                            <tr key={i}>
                                                ...
                                                <td className="py-4 pl-4 pr-3 border-collapse border border-slate-300 text-sm font-medium text-gray-900 whitespace-nowrap sm:pl-1">
                                                    {bajra.commonNameMetabolite}
                                                </td>
                                                <td className="py-4 pl-4 pr-3 border-collapse border border-slate-300 text-sm font-medium text-gray-900 sm:pl-1">
                                                    {bajra.IUPACNameMetabolite}
                                                </td>
                                                <td className="py-4 pl-4 pr-3 border-collapse border border-slate-300 text-sm font-medium text-gray-900 whitespace-nowrap sm:pl-1">
                                                    {bajra.molecularWeight}
                                                </td>
                                                <td className="py-4 pl-4 pr-3 border-collapse border border-slate-300 text-sm font-medium text-gray-900 whitespace-nowrap sm:pl-1">
                                                    {bajra.molecularFormula}
                                                </td>
                                                <td className="py-4 pl-4 pr-3 border-collapse border border-slate-300 text-sm font-medium text-gray-900 sm:pl-1">
                                                    {bajra.canonicalSmiles}
                                                </td>
                                                <td className="py-4 pl-4 pr-3 border-collapse border border-slate-300 text-sm font-medium text-gray-900 whitespace-nowrap sm:pl-1">
                                                    {bajra.references}
                                                </td>
                    ...
                    <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                        <div>
                            <p className="text-sm text-gray-700">
                                ...
                                <span className="font-medium">{bajras.length}</span> results
                            </p>
                        </div>
                        <div>
